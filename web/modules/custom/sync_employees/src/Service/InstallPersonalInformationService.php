 ...
 */
class InstallPersonalInformationService {
    private $fields = [
        'field_personal_fio',
        'field_personal_fiz_code',
        'field_personal_phone',
        'field_personal_birthdate',
    ];
    ...
    public function deleteFieldConfig(): void {
        foreach ($this->fields as $field_name) {
            $instance = FieldConfig::loadByName('profile', 'personal_information', $field_name);
            if ($instance) {
                $instance->delete();
            }
        }
    ...
    public function deleteEntityFormDisplay(): void {
        $form_display_id = 'profile.personal_information.default';
    ...
    public function deleteEntityViewDisplay(): void {
        $view_display_id = 'profile.personal_information.default';
    ...
    public function deleteProfileType(): void {
        ...
        $profile_type = $profile_type_storage->load('personal_information');
        if ($profile_type) {
            $profile_type->delete();
        }
    }
